...
function TrainingModel() {
  ...
  return (
    <div className="training-model-container">
      ...
      <div className="model-report-wrapper">
        <div className="model-report-container">
          <div className="model-report-left">
            <table className="stock-table model-metrics-table">
              <thead>
                <tr>
                  <th style={{color: 'white', backgroundColor: '#121212'}}>Class</th>
                  <th style={{color: '#00FF00', backgroundColor: '#121212'}}>Precision</th>
                  <th style={{color: '#FFA500', backgroundColor: '#121212'}}>Recall</th>
                  <th style={{color: '#FF0000', backgroundColor: '#121212'}}>f1-score</th>
                  <th style={{color: 'white', backgroundColor: '#121212'}}>Support</th>
                </tr>
              </thead>
              <tbody>
          ...
          <div className="model-report-right">
            ...
            <div className="retrain-btn-container">
